...
import 'package:life_counter/widgets/player_addlifechange_long_press.dart';
import 'package:life_counter/widgets/reset_button.dart';

class LifeCounterApp2PlayerLongPress extends StatelessWidget {
  const LifeCounterApp2PlayerLongPress({super.key});
        ...
        children: [
          Expanded(
            child: Row(
              children: [
                Expanded(
                  child: PlayerAddLifeChangeLongPress(
