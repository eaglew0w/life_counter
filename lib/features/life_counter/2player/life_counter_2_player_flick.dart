...
class LifeCounter2PlayerFlick extends ConsumerWidget {
  final String title;
  const LifeCounter2PlayerFlick({super.key, required this.title});
  ...
  Widget _buildPlayer(WidgetRef ref, Players player, PlayerPosition position) {
    ...
    return Player(
      ...
      loseButton: LifeChangeButtonFlick(
        ...
        onFlickFunc: () =>
            ref.read(provider.notifier).changeLife(ChangeLifeInfo.loseOnFlick),
      ...
      gainButton: LifeChangeButtonFlick(
        ...
        onFlickFunc: () =>
            ref.read(provider.notifier).changeLife(ChangeLifeInfo.gainOnFlick),
