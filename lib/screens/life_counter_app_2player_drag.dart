...
import 'package:life_counter/widgets/player_addlifechange_drag.dart';
import 'package:life_counter/widgets/reset_button.dart';

class LifeCounterApp2PlayerDrag extends StatelessWidget {
  const LifeCounterApp2PlayerDrag({super.key});
          ...
          Expanded(
            child: Row(
              children: [
                Expanded(
                  child:
                      PlayerAddLifeChangeDrag(playerProvider: player1Provider),
                ),
                Expanded(
                  child:
                      PlayerAddLifeChangeDrag(playerProvider: player2Provider),
                ),
              ],
            ),
          ),
